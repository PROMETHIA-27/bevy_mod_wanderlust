...
/// The recommended bundle for creating a first-person character controller. Includes the necessary components for a character controller
...
/// A flying controller with spaceship-like controls.
#[derive(Bundle)]
pub struct SpaceshipControllerBundle {
    /// See [`CharacterController`].
    pub controller: CharacterController,
    /// See [`ControllerSettings`].
    pub settings: ControllerSettings,
...
impl Default for SpaceshipControllerBundle {
    fn default() -> Self {
        Self {
            controller: default(),
            settings: ControllerSettings {
                ...
                up_vector: Vec3::Y,
                gravity: 0.0,
                max_ground_angle: 0.0,
                min_float_offset: 0.0,
                max_float_offset: 0.0,
                jump_time: 0.0,
                jump_initial_force: 0.0,
                jump_force: 0.0,
                jump_stop_force: 0.0,
                jump_decay_function: |_| 0.0,
                jump_skip_ground_check_duration: 0.0,
                extra_jumps: 0,
                coyote_time_duration: 0.0,
                jump_buffer_duration: 0.0,
                force_scale: vec3(1.0, 1.0, 1.0),
                float_cast_length: 0.0,
                float_cast_origin: vec3(0.0, 0.0, 0.0),
                float_cast_collider: Collider::ball(0.0),
                float_distance: 0.0,
                float_strength: 0.0,
                float_dampen: 0.0,
                upright_spring_strength: 0.0,
                upright_spring_damping: 0.0,
            },
            input: default(),
            rigidbody: default(),
            collider: Collider::capsule(vec3(0.0, 0.0, 0.0), vec3(0.0, 0.5, 0.0), 0.5),
